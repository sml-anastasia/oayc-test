...
export declare type Breakpoint<C extends Config> = {
    breakpoint: keyof C;
...
declare type Return<C extends Config, D> = D extends undefined ? Breakpoint<C> | typeof EMPTY_BREAKPOINT : D extends keyof C ? Breakpoint<C> : never;
/**
